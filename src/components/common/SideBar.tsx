  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.action_container}>
        <button className={styles.action_button} onClick={() => pageRouteHandler('')}>홈</button>
        <button className={styles.action_button} onClick={() => pageRouteHandler('users')}>프로필</button>
